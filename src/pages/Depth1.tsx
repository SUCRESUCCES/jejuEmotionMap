...
// 리팩토링된 컴포넌트들
import DateRangePicker from '../../archived/depth1/Header/DateRangePicker';
import ChartCard from '../../archived/depth1/Charts/ChartCard';
import WeatherDisplay from '../../archived/depth1/WeatherInfo/WeatherDisplay';
// HoverBox 컴포넌트들 (리팩토링됨)
import {
  UdoHoverBox,
  ChujaHoverBox,
  SeongsanHoverBox,
  ...
  JocheonHoverBox,
  GujwaHoverBox,
} from '../features/dashboard/components/Map/HoverBoxes';

// 누락된 헬퍼 컴포넌트들
function Group12() {
  return (
    <div className="absolute contents inset-[78.44%_71.59%_12.28%_20.64%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[78.44%_71.59%_12.28%_20.64%] leading-[normal] not-italic text-[#7f8c8d] text-[11px] text-center text-nowrap">12/13</p>
    </div>
  );
}

function GroupBackgroundImageAndText({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[78.44%_9.93%_12.28%_82.29%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[78.44%_9.93%_12.28%_82.29%] leading-[normal] not-italic text-[#7f8c8d] text-[11px] text-center text-nowrap">{text}</p>
    </div>
  );
}

function GroupBackgroundImageAndText1({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[49.16%_89.72%_41.56%_3.89%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[49.16%_89.72%_41.56%_3.89%] leading-[normal] not-italic text-[#7f8c8d] text-[11px] text-nowrap text-right">{text}</p>
    </div>
  );
}

function GroupBackgroundImageAndText2({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[60.49%_89.72%_30.23%_3.89%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[60.49%_89.72%_30.23%_3.89%] leading-[normal] not-italic text-[#7f8c8d] text-[11px] text-nowrap text-right">{text}</p>
    </div>
  );
}

function GroupBackgroundImageAndText3({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[8.68%_89.72%_82.04%_3.89%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[8.68%_89.72%_82.04%_3.89%] leading-[normal] not-italic text-[#7f8c8d] text-[11px] text-nowrap text-right">{text}</p>
    </div>
  );
}

function GroupBackgroundImageAndText4({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[78.44%_70.59%_12.28%_21.64%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[78.44%_70.59%_12.28%_21.64%] leading-[normal] not-italic text-[#7f8c8d] text-[11px] text-center text-nowrap">{text}</p>
    </div>
  );
}
...
function VectorBackgroundImage() {
  return (
    <svg className="absolute block h-[114px] inset-[18.57%_-0.33%_0%_8.47%] w-[331px]" fill="none" preserveAspectRatio="none" viewBox="0 0 331 114">
      <path d="M0 114L331 0V114H0Z" fill="url(#linearGradient-vbg)" fillOpacity="0.1" />
      <defs>
        <linearGradient id="linearGradient-vbg" x1="165.5" x2="165.5" y1="0" y2="114" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3498db" />
          <stop offset="1" stopColor="#2980b9" stopOpacity="0" />
        </linearGradient>
      </defs>
    </svg>
  );
...
function VectorBackgroundImage1() {
  return (
    <svg className="absolute block h-[114px] inset-[0.82%_87.5%_20.78%_3.61%] w-[32px]" fill="none" preserveAspectRatio="none" viewBox="0 0 32 114">
      <path d="M0 0L32 114H0V0Z" fill="url(#linearGradient-vbg1)" fillOpacity="0.1" />
      <defs>
        <linearGradient id="linearGradient-vbg1" x1="16" x2="16" y1="0" y2="114" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3498db" />
          <stop offset="1" stopColor="#2980b9" stopOpacity="0" />
        </linearGradient>
      </defs>
...
function GroupBackgroundImage() {
  return (
    <div className="absolute h-[140px] inset-[0%_87.5%_0%_0%] w-[315px]" data-name="Group">
      <svg className="absolute block h-px inset-[0%_0%_99.29%_0%] w-[315px]" fill="none" preserveAspectRatio="none" viewBox="0 0 315 1">
        <path d="M0 0.5H315" stroke="#e0e0e0" strokeWidth="1" />
      </svg>
    </div>
  );
}
...
function IconBackgroundImage() {
  return (
    <svg className="absolute block h-4 inset-[39.73%_68.33%_52.4%_26.11%] w-5" fill="none" preserveAspectRatio="none" viewBox="0 0 20 16">
      <path d="M2 0C0.9 0 0 0.9 0 2V14C0 15.1 0.9 16 2 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0H2ZM2 2H18V4H2V2ZM2 8H18V14H2V8Z" fill="#34495e" />
    </svg>
  );
}
...
function TextBackgroundImageAndText({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[35.38%_14.72%_57.75%_26.11%]" data-name="Text">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold inset-[35.38%_14.72%_57.75%_26.11%] leading-[normal] not-italic text-[#2c3e50] text-lg">{text}</p>
    </div>
  );
}
...
function ContainerBackgroundImageAndText({ text }: { text: string }) {
  return (
    <div className="absolute contents inset-[35.38%_75.56%_57.75%_14.72%]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[35.38%_75.56%_57.75%_14.72%] leading-[normal] not-italic text-[#7f8c8d] text-sm">{text}</p>
    </div>
  );
}

function Container7({ onNavigateToDepth2 }: { onNavigateToDepth2: (region: string) => void }) {
  return (
    <div className="absolute h-[73px] inset-[51.35%_1.39%_45.04%_1.39%] w-[360px]" data-name="Container">
      <div className="absolute bg-white inset-0 rounded-lg shadow-md" />
      <IconBackgroundImage />
      <TextBackgroundImageAndText text="2.8%" />
      <ContainerBackgroundImageAndText text="0.490" />
      <button
        onClick={() => onNavigateToDepth2('default')}
        className="absolute bottom-2 font-['Inter:Medium',sans-serif] font-medium inset-x-2 not-italic px-4 py-2 rounded-md text-[#3498db] text-sm top-auto hover:bg-blue-50"
      >
        상세 보기
      </button>
    </div>
...
// 리팩토링된 Hook 사용
import { useRegionHover } from '../features/dashboard/hooks/useRegionHover';
import { getTooltipPosition } from '../features/dashboard/constants/tooltipPositions';
import { RegionTooltip } from '../features/dashboard/components/Map/RegionTooltipCard';
...
export default function Depth1Dashboard({ 
  ...
  return (
    <div className="relative w-[1728px] h-[1117px]" data-name="depth1_Dashboard_원본">
      {/* 배경 이미지는 App.tsx로 이동 */}
