...
function ReportHeader({ 
  startDate, endDate, tempStartDate, tempEndDate, onTempStartDateChange, onTempEndDateChange, onSearch 
}: Pick<Depth2ReportProps, 'startDate' | 'endDate' | 'tempStartDate' | 'tempEndDate' | 'onTempStartDateChange' | 'onTempEndDateChange' | 'onSearch'>) {
  return (
        ...
        {data.platform_distribution && data.platform_distribution.length > 0 && (
          <div className="flex-[1.5]">
            ...
            <div className="rounded-[8px] border border-[#E0E7E9] overflow-hidden">
              ...
              {(() => {
                const total = data.platform_distribution!.reduce((sum, p) => sum + p.count, 0);
                return data.platform_distribution!.map((platform, index) => {
                  const percentage = ((platform.count / total) * 100).toFixed(1);
                  return (
                    <div 
                      key={index}
                      className={`flex items-center px-[16px] py-[10px] bg-white ${index < data.platform_distribution!.length - 1 ? 'border-b border-[#F5F5F5]' : ''}`}
                    >
...
function InsightSection({ data }: { data: RegionAnalysisData }) {
  return (
    <div>
      ...
      <div className="bg-white rounded-[16px] p-[40px] border border-[#E0E7E9] shadow-[0px_4px_20px_0px_rgba(0,188,212,0.05)]">
        ...
        <div className="mb-[32px]">
          ...
          <p className="text-[14px] text-[#455A64] leading-[170%]">
            구좌읍 관련 게시글 45건 중 28건에서 지역 생활과 관련된 의견이 확인되었습니다. 교통 관련 의견(12건)이 가장 많았으며, 사회적 고립감(8건), 의료 접근성(6건) 순으로 언급되었습니다.
          </p>
        </div>
        ...
        <div className="mb-[32px]">
          ...
          <div className="mb-[24px]">
            ...
            <div className="pl-[20px] mb-[12px]">
              ...
              <p className="text-[14px] text-[#455A64] leading-[170%] mb-[12px]">
                12건의 게시글에서 버스 배차 간격 관련 불편 언급
              </p>
              
              <p className="text-[14px] font-bold text-[#90A4AE] mb-[8px]">해석:</p>
              <p className="text-[14px] text-[#455A64] leading-[170%] mb-[12px]">
                일부 주민들은 버스가 하루 3~5회만 운행되어 병원, 마트 이용이 어렵다고 느끼고 있습니다. 특히 차량이 없는 주민이나 고령자의 경우 택시 비용 부담도 언급되었습니다.
              </p>
          ...
          <div className="mb-[24px]">
            ...
            <div className="pl-[20px] mb-[12px]">
              <p className="text-[14px] font-bold text-[#90A4AE] mb-[8px]">데이터:</p>
              <p className="text-[14px] text-[#455A64] leading-[170%] mb-[12px]">
                8건의 게시글에서 친구 사귀기 어려움 언급
              </p>
              
              <p className="text-[14px] font-bold text-[#90A4AE] mb-[8px]">해석:</p>
              <p className="text-[14px] text-[#455A64] leading-[170%] mb-[12px]">
                최근 구좌읍으로 이주한 일부 주민들이 사회적 연결망 형성에 어려움을 겪고 있다는 의견이 있었습니다. '이사 온 지 3개월인데 친구가 없다', '젊은 사람이 별로 없어 외롭다'는 표현이 확인되었습니다.
              </p>
              ...
              <div className="flex flex-col gap-[6px]">
                <div className="flex items-start gap-[8px]">
                  <span className="text-[#00BFA5] shrink-0">•</span>
                  <p className="text-[13px] text-[#6b7280] leading-[170%]">
                    "이사 온 지 3개월인데 친구가 한 명도 없어요"
                  </p>
                </div>
                <div className="flex items-start gap-[8px]">
                  <span className="text-[#00BFA5] shrink-0">•</span>
                  <p className="text-[13px] text-[#6b7280] leading-[170%]">
                    "동네에 젊은 사람이 별로 없어서 외로워요"
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-[32px]">
          ...
          <div className="mb-[20px]">
            ...
            <div className="pl-[20px]">
              <p className="text-[14px] font-bold text-[#90A4AE] mb-[8px]">관찰:</p>
              <p className="text-[14px] text-[#455A64] leading-[170%] mb-[12px]">
                교통 불편을 언급한 게시글에서 의료, 장보기 등 다른 생활 불편도 함께 언급되는 경향이 있었습니다.
              </p>
              
              <p className="text-[14px] font-bold text-[#90A4AE] mb-[8px]">해석:</p>
              <p className="text-[14px] text-[#455A64] leading-[170%]">
                버스 배차 간격이 길어지면 병원, 마트 등 필수 시설 이용이 어려워진다는 의견으로 해석됩니다.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="pl-[20px]">
            ...
            <p className="text-[14px] text-[#455A64] leading-[170%] mb-[12px]">
              일부 게시글에서 월정리 바다, 김녕 해변 등 자연환경에 대한 긍정적 평가가 있었습니다.
            </p>
      ...
      <div className="bg-white rounded-[16px] p-[40px] border border-[#E0E7E9] shadow-[0px_4px_20px_0px_rgba(0,188,212,0.05)]">
        <div className="flex flex-col gap-[20px]">
          ...
          <div>
            ...
            <div className="flex flex-col gap-[8px] pl-[20px]">
              <p className="text-[14px] text-[#374151] leading-[170%]">• 분석 게시글: 28건</p>
              <p className="text-[14px] text-[#374151] leading-[170%]">• 구좌읍 인구: 7,826명</p>
              <p className="text-[14px] text-[#374151] leading-[170%]">• 샘플 비율: 0.36%</p>
              <p className="text-[14px] text-[#374151] leading-[170%] mt-[8px]">→ 전체 주민의 0.36%에 해당하는 의견으로, 대표성에 한계가 있습니다.</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-[8px] pl-[20px]">
              <p className="text-[14px] text-[#374151] leading-[170%]">• 분석 기간: 7일</p>
...
export default function Depth2Report({ 
  ...
  const defaultData = useMemo<RegionAnalysisData>(() => ({
    ...
    platform_distribution: [
      { platform: '당근마켓', count: 12, color: '#FF6B35' },
      { platform: '네이버 제주맘카페', count: 8, color: '#03C75A' },
      { platform: '디시인사이드', count: 5, color: '#4A90E2' },
      { platform: '제주도청 건의', count: 3, color: '#00BFA5' },
      { platform: '네이버 뉴스', count: 6, color: '#1EC800' },
      { platform: 'X', count: 4, color: '#000000' },
      { platform: '픽제주', count: 2, color: '#FF9500' },
    ...
    negative_issues: [
      {
        keyword: '버스 배차 간격 너무 길어',
        severity: '심각',
        voices: [
          '버스가 하루에 3번밖에 안 다녀서 병원 못 가요',
          '버스 시간 못 맞추면 택시비 2만원...'
        ],
        context: '하루 3~5회 운행으로 병원·마트 이용 불편',
        related_issues: '의료 접근성, 고령자 이동권'
      },
      {
        keyword: '소아과 없어서 제주시까지 가야 함',
        severity: '중간',
        voices: [
          '애가 열나면 제주시 소아과까지 40분... 응급 상황 무서워요'
        ],
        context: '구좌읍 내 소아과 부재, 제주시까지 40분 이동',
        related_issues: '육아 인프라'
      }
    ],
    neutral_issues: [
      {
        keyword: '제주시 출퇴근',
        voices: [
          '구좌에 일자리 없어서 제주시로 출퇴근 중',
          '월정리까지 출퇴근하는데 차 없으면 힘들더라구요',
          '제주시까지 매일 왕복 1시간 반',
          '구좌에 괜찮은 직장이 없어서 어쩔 수 없이...'
        ],
        context: '구좌읍 내 일자리 부족으로 제주시 통근'
      }
    ],
    trend_data: [0.52, 0.54, 0.58, 0.55, 0.59, 0.62, 0.65, 0.68],
    insights: []
  }), [selectedRegion]);
